...
export default function Carousel() {
  ...
  return (
    ...
    damping: 20,
          ...
          className="absolute z-45 pointer-events-none -translate-x-1/2 -translate-y-1/2"
      ...
      <div className='z-50 absolute top-1/2 px-20'>
        <div className='text-7xl font-semibold text-white tracking-tighter'>Welcome to <br /> Otaku Haul</div>
       ...
       <div className='z-50 absolute bottom-5 right-0 px-20'>
